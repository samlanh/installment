...
// 	}
	public function FrmInvoices($data = null)
	{
		...
		$totalAmountExternal->setAttribs(
			array(
				'dojoType' => 'dijit.form.NumberTextBox',
				'required' => 'true',
				'class' => 'fullside ',
		...
		$purchaseType->setAttribs(
			array(
				'dojoType' => 'dijit.form.FilteringSelect',
				'placeholder' => $tr->translate("SELECT_PURCHASE_TYPE"),
				'class' => 'fullside',
				'required' => 'false',
				'autoComplete' => 'false',
				'queryExpr' => '*${0}*',

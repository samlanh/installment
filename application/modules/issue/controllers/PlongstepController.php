...
class Issue_PlongstepController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			...
			$db = new Issue_Model_DbTable_DbPlongStep();
			...
			$link_info=array('module'=>'issue','controller'=>'plongstep','action'=>'edit',);
  ...
  function addAction()
  {
		if($this->getRequest()->isPost()){
			...
			try {
				...
				$_dbmodel = new Issue_Model_DbTable_DbPlongStep();
				$_dbmodel->addPlongStep($_data);
				Application_Form_FrmMessage::Sucessfull("INSERT_SUCCESS","/issue/plongstep");
			}catch (Exception $e) {

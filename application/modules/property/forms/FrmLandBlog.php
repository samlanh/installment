<?php 
Class Property_Form_FrmLandBlog extends Zend_Dojo_Form {
	protected $tr=null;
	...
	public function FrmLandBlog($data=null){
		...
		$title_kh=new Zend_Dojo_Form_Element_ValidationTextBox('title_kh');
		$title_kh->setAttribs(array(
				'dojoType'=>'dijit.form.ValidationTextBox',
				'class'=>'fullside',
				'required'=>true
		));
		...
		if($data!=null){
			...
			$title_kh->setValue($data['title_kh']);
		...
		$this->addElements(array($title_en,$title_kh,$_btn_search,$_status_search,

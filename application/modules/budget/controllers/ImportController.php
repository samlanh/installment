<?php
class Budget_importController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			...
			$db=new Budget_Model_DbTable_DbImport();
			if($this->getRequest()->isPost()){
				...
				$db->BudgetByImport($sheetData);
				Application_Form_FrmMessage::Sucessfull("Import Successfully", "/budget/import");
			}
			else{

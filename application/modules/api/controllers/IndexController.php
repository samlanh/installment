...
class Api_IndexController extends Zend_Controller_Action {
	...
	public function indexAction(){
		...
		print_r(Zend_Json::encode($db->getAllSold($data)));
		exit();
	}
...
// 					'land_id'=>-1,
		...
		print_r(Zend_Json::encode($db->getAllIncome($data)));
		exit();
	}
...
// 					'land_id'=>-1,
		...
		$rs_expense = $db->getExpenseType($data);
...
// 	}
	...
	function projectAction(){//ត្រូវបង់
...
// 		echo $string;
		print_r(Zend_Json::encode($db->projectData()));
		exit();
	}

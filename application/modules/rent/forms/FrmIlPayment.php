<?php 
Class Rent_Form_FrmIlPayment extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmAddIlPayment($data=null){
		...
		$row_loan_number = $_dbRent->getAllRentNumber();
		$options=array(''=>'');
...
// 		$_rate->setValue($value_interest);
		...
		$loan_number = $_dbRent->getRentReceiptByBranch(array("branch_id"=>1));

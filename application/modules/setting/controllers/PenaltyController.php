<?php
class Setting_penaltyController extends Zend_Controller_Action {
	const REDIRECT_URL = '/setting/penalty';
	...
	public function indexAction(){
		try{
			...
			$db = new Setting_Model_DbTable_DbPenaltySetting();
    		...
    		$link=array(
    				'module'=>'setting','controller'=>'penalty','action'=>'edit',
    		);

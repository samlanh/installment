...
class Group_SupplierController extends Zend_Controller_Action {
	...
	public function indexAction(){
		try{
			...
			$collumns = array("BRANCH_NAME","CODE","SUPPLIER_NAME","PHONE","ADDRESS",
					"EMAIL","STATUS");
			$link=array(
					'module'=>'group','controller'=>'supplier','action'=>'edit',
			);
			$this->view->list=$list->getCheckList(10, $collumns,$rs_rows,array('branch_name'=>$link,'supplier_code'=>$link,'name'=>$link));
		}catch (Exception $e){

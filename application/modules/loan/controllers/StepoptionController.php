...
class Loan_StepoptionController extends Zend_Controller_Action
{
	const REDIRECT_URL = '/loan/stepoption';
    ...
    {
    	try{
    		$db = new Loan_Model_DbTable_DbStepOption();
    		...
    		$link=array(
    				'module'=>'loan','controller'=>'stepoption','action'=>'edit',
    		);
    ...
    public function addAction()
    {
    	...
    	$pructis=new Loan_Form_FrmStepOption();

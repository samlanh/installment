   		...
   		try{
   			$db->addPropery($_data);
   				if(!empty($_data['save_new'])){
					...
					Application_Form_FrmMessage::Sucessfull('INSERT_SUCCESS', self::REDIRECT_URL . '/project/index');
				}
   		}catch(Exception $e){
   ...
   function editAction(){
   	...
   	if($this->getRequest()->isPost()){
   		...
   		try{
   			...
   			Application_Form_FrmMessage::Sucessfull("ការ​បញ្ចូល​ជោគ​ជ័យ !",'/project/propertiestype');
   		}catch(Exception $e){
